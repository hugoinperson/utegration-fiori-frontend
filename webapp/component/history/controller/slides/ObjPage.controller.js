sap.ui.define([
	...
	var CustomController = SlideController.extend("utegration.fiori.frontend.component.history.controller.slides.ObjPage");

	CustomController.prototype.onInit = function () {
		SlideController.prototype.onInit.apply(this, arguments);
		
		this.oModel = new JSONModel($.sap.getModulePath("utegration.fiori.frontend.component.history.mockdata", "/Products.json"));
