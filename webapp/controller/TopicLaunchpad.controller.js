sap.ui.define([
	...
	var CustomController = Controller.extend("utegration.fiori.frontend.controller.TopicLaunchpad");

	CustomController.prototype.onInit = function () {
		// Create component
    	sap.ui.component({
            name: "utegration.fiori.frontend.component.launchpad",
            manifestFirst: true,
            async: true
        ...
        // Static variables
        this._COMPONENT_NAME = "launchpad";
        // global variables
    ...
    CustomController.prototype._subscribeEvents = function () {
        ...
        this._compRouter.getRoute("topic-launchpad").attachPatternMatched(this._onRefresh, this);
    };
