sap.ui.define([
	...
	var CustomController = Controller.extend("utegration.fiori.frontend.controller.TopicPrinciples");

	CustomController.prototype.onInit = function () {
		// Create component
    	sap.ui.component({
            name: "utegration.fiori.frontend.component.principles",
            manifestFirst: true,
            async: true
        ...
        // Static variables
        this._COMPONENT_NAME = "principles";
        // global variables
    ...
    CustomController.prototype._subscribeEvents = function () {
        ...
        this._compRouter.getRoute("topic-principles").attachPatternMatched(this._onRefresh, this);
    };
