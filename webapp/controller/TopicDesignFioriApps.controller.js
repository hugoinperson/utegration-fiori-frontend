sap.ui.define([
	...
	var CustomController = Controller.extend("utegration.fiori.frontend.controller.TopicDesignFioriApps");

	CustomController.prototype.onInit = function () {
		// Create component
    	sap.ui.component({
            name: "utegration.fiori.frontend.component.designFioriApps",
            manifestFirst: true,
            async: true
        ...
        // Static variables
        this._COMPONENT_NAME = "designFioriApps";
        // global variables
    ...
    CustomController.prototype._subscribeEvents = function () {
        ...
        this._compRouter.getRoute("topic-designFioriApps").attachPatternMatched(this._onRefresh, this);
    };
