sap.ui.define([
	...
	var CustomController = Controller.extend("utegration.fiori.frontend.controller.TopicIOS");

	CustomController.prototype.onInit = function () {
		// Create component
    	sap.ui.component({
            name: "utegration.fiori.frontend.component.iOS",
            manifestFirst: true,
            async: true
    ...
    CustomController.prototype._subscribeEvents = function () {
        ...
        this._compRouter.getRoute("topic-iOS").attachPatternMatched(this._onRefresh, this);
    };
